...
public class IngredientViewModel extends AndroidViewModel {
    ...
    private IngredientViewModel(Application application, Long ingredientId) {
        ...
        LiveData<Ingredient> mLiveIngredient = getBarRepository().getIngredient(ingredientId);
        mRelatedDrinks.addSource(getBarRepository().getDrinksByIngredient(ingredientId), mRelatedDrinks::setValue);
